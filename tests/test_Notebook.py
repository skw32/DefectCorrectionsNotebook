...
# To-do: Add in additional tests once LZ method and alternative pa steps added to notebook
# Also may want to add interstitial and vacancy test data to configurations list?
...
def test_notebook():
    verified_E_q_lat = 0.20495454545454556
    ...
    # TODO: recalculate and/or update this test!
    # assert test_E_q_lat == pytest.approx(verified_E_q_lat)
